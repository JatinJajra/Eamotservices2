...
const DGMonitoringPage: React.FC = () => {
  ...
  const businessBenefits = [
    {
      ...
      percentage: '30%',
      description: 'Average reduction in operational and maintenance costs through preventive maintenance and fuel optimization',
    ...
    },
    {
      ...
      percentage: '85%',
      description: 'Reduction in unplanned downtime events through proactive alerting and predictive fault detection',
    ...
    },
    {
      ...
      percentage: '25%',
      description: 'Improved generator fuel efficiency through data-driven load management and optimization',
    ...
    },
    {
      ...
      percentage: '20%',
      description: 'Reduction in carbon emissions through optimized generator operations and reduced idle time',
  ...
  const architectureComponents = [
    {
      name: 'IoT Sensors',
      description: 'Advanced sensors gathering real-time data from all critical generator components',
      icon: <Cpu />,
      color: 'text-blue-500'
    },
    {
      name: 'Edge Gateway',
      description: 'Local processing unit for data aggregation and first-level analysis',
      icon: <Wifi />,
      color: 'text-purple-500'
    },
    {
      name: 'Cloud Platform',
      description: 'Secure cloud infrastructure for data storage, processing, and visualization',
      icon: <Cloud />,
      color: 'text-green-500'
    },
    {
      name: 'Analytics Engine',
      description: 'AI-powered analytics for predictive maintenance and performance optimization',
      icon: <BarChart />,
      color: 'text-amber-500'
    },
    {
      name: 'Alert System',
      description: 'Multi-channel notification system for real-time alerting and escalation',
      icon: <BellRing />,
      color: 'text-red-500'
    },
    {
      name: 'Mobile Application',
      description: 'Cross-platform mobile app for remote monitoring and control capabilities',
      icon: <Smartphone />,
    ...
    <>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
              ...
              >
                Advanced real-time monitoring and analytics solution that transforms your diesel generators into smart, connected assets for enhanced reliability, efficiency, and performance.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="w-full lg:w-1/2 lg:pl-10">
              ...
              >
                <div className="mb-4 flex justify-between items-center">
                  <h3 className="text-xl font-semibold">Real-time Monitoring Parameters</h3>
                  ...
                  {monitoringParams.map((param, index) => (
                    ...
                    >
                      <div className="flex justify-center mb-1">
                        <div className={`h-2 w-2 rounded-full ${param.active ? 'bg-green-400' : 'bg-gray-400'}`}></div>
                      </div>
                      <p className="text-xs font-medium whitespace-nowrap overflow-hidden text-ellipsis">{param.name}</p>
                    </motion.div>
                  ))}
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Intelligent Monitoring Architecture</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our IoT monitoring system features a comprehensive end-to-end architecture designed for reliability, security, and scalability
            </p>
          </div>
            ...
            <div className="relative overflow-hidden rounded-xl shadow-lg border border-gray-200 bg-white p-8">
              ...
              <div className="absolute inset-0 pointer-events-none">
                <svg width="100%" height="100%" className="absolute inset-0">
                  ...
                  <line x1="25%" y1="50%" x2="50%" y2="25%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrowhead)" />
                  <line x1="50%" y1="25%" x2="75%" y2="50%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrowhead)" />
                  <line x1="25%" y1="50%" x2="50%" y2="75%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrowhead)" />
                  <line x1="50%" y1="75%" x2="75%" y2="50%" stroke="#CBD5E1" strokeWidth="2" strokeDasharray="4" markerEnd="url(#arrowhead)" />
                </svg>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Comprehensive Monitoring Platform</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our IoT-based monitoring platform provides powerful features to maximize generator performance and reliability
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our IoT monitoring solution delivers measurable business benefits through improved reliability, efficiency, and cost optimization
            </p>
          </div>
            ...
            {businessBenefits.map((benefit, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="text-3xl font-bold">{benefit.percentage}</span>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              See how organizations across industries have transformed their generator operations with our IoT monitoring solution
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-black to-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6">Ready to Optimize Your Generator Performance?</h2>
