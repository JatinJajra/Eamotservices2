  ...
  const batteryOptions: BatteryOption[] = [
    {
      ...
      advantages: [
        " Maintenance-free sealed design – no water refilling required.",
        "Reliable and proven technology with predictable performance.",
        "Lower upfront cost compared to Li-Ion batteries.",
        "Tolerant to overcharging and rugged environmental conditions.",
      ],
      considerations: [
        "Heavier and bulkier for the same energy capacity.",
        "Shorter cycle life and lower depth of discharge.",
        " Venting of gases under stress; needs adequate ventilation.",
        "Reduced performance in high-temperature environments.",
      ],
      applications: [
        "Uninterruptible Power Supplies (UPS) for commercial buildings.",
        "Emergency lighting and fire alarm systems.",
        "Backup power for small-scale telecom and server rooms.",
        "Short-duration backup where weight and size are less critical.",
      ],
      lifespan: "5~10 years",
      icon: Lightbulb,
