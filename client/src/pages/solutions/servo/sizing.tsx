...
const ServoSizingPage: React.FC = () => {
  ...
  const calculateServoSize = () => {
    ...
    let standardSize =
      standardSizes.find((size) => size >= recommendedSize) || recommendedSize;
  ...
  const sizingFeatures = [
    {
      ...
      description:
        "Comprehensive evaluation of your electrical load profiles, peak demands, and power quality requirements.",
      color: "bg-blue-50",
    },
    {
      ...
      description:
        "Detailed measurement and characterization of incoming voltage fluctuations to determine stabilization requirements.",
      color: "bg-amber-50",
    },
    {
      ...
      description:
        "Assessment of sensitive equipment vulnerability to voltage fluctuations and required protection levels.",
      color: "bg-green-50",
    },
    {
      ...
      description:
        "Expert recommendation of optimal servo stabilizer technology based on application requirements.",
      color: "bg-purple-50",
    },
    {
      ...
      description:
        "Evaluation of space requirements, ventilation needs, and infrastructure considerations for servo installation.",
      color: "bg-red-50",
    },
    {
      ...
      description:
        "Comprehensive technical specifications and documentation for your optimal servo stabilizer solution.",
      color: "bg-indigo-50",
    },
  ];
  ...
  //     benefits: [
  //       "Safeguards ATMs, servers, and transaction processing systems from voltage fluctuations",
  //       "Ensures uninterrupted operation of banking software and digital platforms",
  //       " Protects critical financial data from corruption due to unstable power",
  //       " Enhances lifespan and reliability of sensitive electronic infrastructure",
  //     ],
  //     sizing:
  //       "Sized at 1.5x to 1.7x of the connected load to accommodate sensitive electronics and ensure consistent uptime",
  //   },
  // ];
  ...
  },
  {
    ...
    sizing: 'Sized at 1.5x to 1.7x of the connected load to accommodate sensitive electronics and ensure consistent uptime',
    specialConsiderations: [
      'Inrush current handling for on-site backup systems and equipment restarts',
      'Harmonic filtering to maintain power quality in digital-heavy environments',
      'Fast response time to handle sudden voltage drops or spikes during peak transaction hours'
    ]
  }
];
  ...
  const technicalFactors = [
    {
      ...
      description:
        "The wider the input range, the more protection against severe fluctuations",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
              ...
              >
                Expert sizing and selection services to ensure your facility has
                the optimal servo stabilizer solution for reliable voltage
                regulation and equipment protection.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <div className="w-full lg:w-1/2 lg:pl-10">
              ...
              >
                <h3 className="text-xl font-bold mb-4 text-gray-800">
                  Servo Stabilizer Size Calculator
                </h3>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      <Label htmlFor="load-kva" className="text-gray-700">
                    ...
                    <div>
                      <Label htmlFor="voltage" className="text-gray-700">
                        Supply Voltage (V)
                      </Label>
                      <RadioGroup
                        value={voltageLevel}
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="v-230" className="text-gray-700">
                            230V
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="415" id="v-415" />
                          <Label htmlFor="v-415" className="text-gray-700">
                            415V
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      <Label htmlFor="application" className="text-gray-700">
                        Application Type
                      </Label>
                      <RadioGroup
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="app-it" className="text-gray-700">
                            IT/Data Center
                          </Label>
                        </div>
                      </RadioGroup>
                    ...
                    <div>
                      <div className="flex justify-between">
                        <Label htmlFor="fluctuation" className="text-gray-700">
                          Voltage Fluctuation (%)
                        </Label>
                    ...
                    {calculationResult && (
                      <div className="bg-primary-50 p-4 rounded-lg mt-4">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          ...
                          detailed assessment based on your specific
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Our Sizing & Selection Process
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              We employ a comprehensive methodology to determine the optimal
              servo stabilizer specifications for your unique requirements
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Different environments have unique stabilization requirements. Our
              application-specific approach ensures optimal protection.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <Tabs defaultValue="industrial" className="w-full">
              ...
              {applications.map((app, index) => (
                <TabsContent
                  key={index}
                  value={app.name.toLowerCase().split(" ")[0]}
                  className="mt-6"
                >
                  <Card>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <CardDescription className="text-base">
                            Specialized servo stabilizer solutions for{" "}
                            {app.name.toLowerCase()} environments
                          </CardDescription>
                        </div>
                      </div>
                    </CardHeader>
                        ...
                        <div>
                          ...
                          <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="mt-4 pt-4 border-t border-gray-200">
                              ...
                              <ul className="space-y-1">
  {app.specialConsiderations.map((point, idx) => (
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Multiple technical factors influence the optimal servo stabilizer
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      ...
                      <p className="text-gray-600">
                        A manufacturing facility with CNC machines and sensitive
                        equipment was experiencing frequent equipment failures
                        and production stoppages due to unstable voltage supply.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        After comprehensive load analysis and voltage
                        monitoring, we recommended a 150 kVA servo stabilizer
                        with rapid response time and high correction capacity.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-600">
                          89% reduction in equipment failures
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                        <span className="text-gray-600">
                          42% decrease in production downtime
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                  ...
                  <div className="space-y-6 flex-grow">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 text-sm mt-1">
                          Comprehensive measurement of load characteristics and
                          patterns
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 text-sm mt-1">
                          72-hour monitoring of voltage variation and quality
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 text-sm mt-1">
                          Evaluation of equipment sensitivity and protection
                          requirements
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-white/70 text-sm mt-1">
                          Custom sizing and specification development for
                          optimal protection
                        </p>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto mb-8 opacity-90">
              Contact our servo stabilizer specialists to begin the assessment
              and sizing process for your specific requirements. Our experts
              will help you identify the optimal solution for your facility.
            </p>
            <Button
              asChild
              size="lg"
