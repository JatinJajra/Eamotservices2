...
const ServoInstallationPage: React.FC = () => {
  ...
  const { ref: processRef, inView: processInView } = useIntersectionObserver({
    threshold: 0.2,
  });
  const { ref: expertiseRef, inView: expertiseInView } =
    useIntersectionObserver({ threshold: 0.2 });
  const { ref: benefitsRef, inView: benefitsInView } = useIntersectionObserver({
    threshold: 0.2,
  });
    ...
    <div className="bg-black text-white">
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/videos/servo-installation-hero.mp4"
              type="video/mp4"
            />
            <img
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8">
            ...
            <div className="lg:col-span-6">
              ...
              >
                Transform your power quality management with our precision servo
                stabilizer installation service. Our expert technicians ensure
                flawless implementation, perfect system integration, and
                comprehensive performance validation - maximizing your
                stabilizer's effectiveness from day one.
              </motion.p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Our <span className="text-primary">5-Step</span> Installation
              Process
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              We follow a methodical approach to ensure perfect implementation
            ...
            {[
              {
                ...
                description:
                  "Our engineers conduct a meticulous analysis of your facility's requirements",
              ...
              },
              {
                ...
                description:
                  "We create a detailed roadmap for installation with minimal disruption",
              ...
              },
              {
                ...
                description:
                  "Our certified specialists execute the installation with meticulous attention",
              ...
              },
              {
                ...
                description:
                  "27-point commissioning protocol tests across multiple scenarios",
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <p className="text-white text-sm">
                    Our certified technicians implementing a high-capacity servo
                    stabilizer system
                  </p>
                </div>
              </motion.div>
            ...
            <div className="md:w-1/2">
              ...
              >
                Our elite installation team brings unparalleled expertise to
                every project. With an average of 15+ years in servo technology
                implementation, our specialists have successfully completed over
                500 installations across multiple industries.
              </motion.p>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our expert installation service delivers measurable advantages for
              your power management infrastructure
            </p>
          </div>
              ...
              },
              {
                ...
                description: (
                  <ul className="list-disc list-outside pl-5 text-gray-700 space-y-1">
                    ...
                    <li>
                      Fast support for any post-installation performance
                      concerns
                    </li>
                  </ul>
                ),
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Don't risk improper installation compromising your investment. Our
              certified technicians deliver guaranteed results with minimal
